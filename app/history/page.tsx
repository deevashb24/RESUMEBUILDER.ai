...
import { FileText, Calendar, ArrowRight, ArrowLeft, Clock, Lock, Download, CheckCircle } from "lucide-react"
...
export default function HistoryPage() {
  ...
  if (loading) return <div className="p-12 text-center text-gray-500">Loading account...</div>
  if (!user) {
    router.replace("/")
    return null
  }
      ...
      <div className="max-w-4xl mx-auto space-y-8">
        ...
        <div className="flex items-center gap-4">
          ...
          <div>
            ...
            <p className="text-gray-500">Access and download your previously generated documents.</p>
          </div>
        </div>
