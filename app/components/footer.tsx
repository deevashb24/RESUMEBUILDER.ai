                ...
                <div className="grid grid-cols-1 md:grid-cols-4 gap-12">
                    ...
                    <div className="col-span-1 md:col-span-2">
                        ...
                        <div className="mt-6 flex gap-4">
                            {/* X (Formerly Twitter) */}
                            <a href="https://x.com/your-profile" target="_blank" rel="noopener noreferrer" className="text-muted-foreground hover:text-primary transition-colors">
                            ...
                            {/* Reddit */}
                            <a href="https://reddit.com/u/your-username" target="_blank" rel="noopener noreferrer" className="text-muted-foreground hover:text-primary transition-colors">
