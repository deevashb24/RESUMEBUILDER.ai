        ...
        `}} />
                    ...
                    <div className="w-full flex justify-between text-[9pt] leading-tight">
                        ...
                        <span className="flex items-center gap-2">
                            <span className={`inline-flex items-center gap-1 relative group/item ${!doc.header.email?.trim() ? 'hidden' : ''}`}>
                                ...
                                <span className="iitk-hyperlink-box">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="9" height="9" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><rect width="20" height="16" x="2" y="4" rx="2"/><path d="m22 7-8.97 5.7a1.94 1.94 0 0 1-2.06 0L2 7"/></svg>
                            ...
                            <span className={`inline-flex items-center gap-1 relative group/item ${!doc.header.phone?.trim() ? 'hidden' : ''}`}>
                                ...
                                <span className="iitk-hyperlink-box">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="9" height="9" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M22 16.92v3a2 2 0 0 1-2.18 2 19.79 19.79 0 0 1-8.63-3.07A19.5 19.5 0 0 1 4.69 13.5 19.79 19.79 0 0 1 1.65 5 2 2 0 0 1 3.64 3h3a2 2 0 0 1 2 1.72c.127.96.361 1.903.7 2.81a2 2 0 0 1-.45 2.11L7.91 10.6a16 16 0 0 0 6 6l1.27-1.27a2 2 0 0 1 2.11-.45c.907.339 1.85.573 2.81.7A2 2 0 0 1 22 16.92z"/></svg>
                    ...
                    <div className="w-full flex justify-between text-[9pt] leading-tight mt-1">
                        ...
                        <span className="flex items-center gap-2">
                            <span className={`inline-flex items-center gap-1 relative group/item ${!doc.header.linkedin?.trim() ? 'hidden' : ''}`}>
                                ...
                                <span className="iitk-hyperlink-box">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="9" height="9" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M16 8a6 6 0 0 1 6 6v7h-4v-7a2 2 0 0 0-2-2 2 2 0 0 0-2 2v7h-4v-7a6 6 0 0 1 6-6z"/><rect width="4" height="12" x="2" y="9"/><circle cx="4" cy="4" r="2"/></svg>
                        ...
                        {doc.professionalExperience.filter(e => e.isVisible !== false).map((exp, i) => {
                            ...
                            return (
                                <div key={exp.id || i} className="mb-1 iitk-keep-together group/item relative" data-avoid-break="true">
                                    ...
                                    <div className="bg-[#e5e7eb] w-full px-[6pt] py-[4pt] flex justify-between items-center text-[10pt] mb-[2pt]">
                                        <div>
                                        ...
                                        <EditableField value={exp.displayDate || ""} onUpdate={v => onUpdate?.(dPath, v)} className="text-gray-700 italic text-[9pt] pr-[4pt]" placeholder="Date" />
                                    </div>
                        ...
                        {doc.projectsAndWorkshops.filter(p => p.isVisible !== false).map((proj, i) => {
                            ...
                            return (
                                <div key={proj.id || i} className="mb-1 iitk-keep-together group/item relative" data-avoid-break="true">
                                    ...
                                    <div className="bg-[#e5e7eb] w-full px-[6pt] py-[4pt] flex justify-between items-center text-[10pt] mb-[1pt]">
                                        ...
                                        }} className="text-gray-700 italic text-[9pt] pr-[4pt]" placeholder="Date" />
                                    </div>
                                    {proj.context && (
                ...
                {doc.technicalSkillsTable && doc.technicalSkillsTable.length > 0 && (
                    <div className="mb-[2mm] iitk-keep-together">
                        ...
                        <ul className="iitk-bullet-list text-[10pt]">
                            {doc.technicalSkillsTable.filter(s => s.isVisible !== false).map((skill, i) => (
                                <li key={skill.id || i} className="group/row relative">
                                    <RemoveItemButton onClick={() => {
                                        onUpdate?.(`layoutOverrides.iitk.technicalSkillsTable.${i}.isVisible`, false);
                                    }} className="top-0 -left-6 right-auto z-10" />
                                    <strong><EditableField value={skill.label} onUpdate={v => onUpdate?.(`layoutOverrides.iitk.technicalSkillsTable.${i}.label`, v)} className="inline" /></strong>:{" "}
                                    ...
                                    }} renderCustom={<span dangerouslySetInnerHTML={{ __html: skill.text.replace(/\s\|\s/g, ', ') }} />} className="inline" />
                                </li>
                            ))}
                        </ul>
                    ...
                    <div className="mb-[2mm]">
                        ...
                        <ul className="iitk-bullet-list text-[10pt]">
                            {doc.positionsOfResponsibility.filter(p => p.isVisible !== false).map((pos, i) => (
                                <li key={pos.id || i} className="mb-[3pt] iitk-keep-together group/item relative" data-avoid-break="true">
                                    <RemoveItemButton onClick={() => {
                                    ...
                                    <div className="flex justify-between items-baseline">
                                        <div>
                                            <EditableField value={pos.role} onUpdate={v => onUpdate?.(`layoutOverrides.iitk.positionsOfResponsibility.${i}.role`, v)} className="font-bold inline-block" />
                                            {pos.role?.trim() && pos.organization?.trim() && <span className="mx-1">—</span>}
                                            <EditableField value={pos.organization} onUpdate={v => onUpdate?.(`layoutOverrides.iitk.positionsOfResponsibility.${i}.organization`, v)} className="italic inline-block" />
                                        </div>
                                        <EditableField value={pos.displayDate || ""} onUpdate={v => onUpdate?.(`layoutOverrides.iitk.positionsOfResponsibility.${i}.displayDate`, v)} className="italic text-[9pt] text-gray-700 whitespace-nowrap ml-4" placeholder="Date" />
                                    </div>
                                    {pos.bullets.filter(b => b.trim()).length > 0 && (
                                        <ul className="iitk-bullet-list mt-[1pt]" style={{ paddingLeft: '12pt' }}>
                        ...
                        {section.items?.filter((item: any) => item.isVisible !== false).map((item: any, ii: number) => (
                            <div key={item.id || ii} className="mb-[2pt] iitk-keep-together group/item relative">
                                ...
                                <div className="bg-[#e5e7eb] w-full px-[6pt] py-[4pt] flex justify-between items-center text-[10pt] mb-[1pt]">
                                    ...
                                    <EditableField value={item.displayDate || ""} onUpdate={v => onUpdate?.(`layoutOverrides.iitk.customLayoutSections.${si}.items.${ii}.displayDate`, v)} className="italic text-[10pt] pr-[4pt]" placeholder="Date" />
                                </div>
                                <ul className="iitk-bullet-list mt-[1pt]">
...
const SectionHeader = ({ title, suffix }: { title: React.ReactNode, suffix?: string }) => (
    <div className="w-full font-bold text-[12pt] flex justify-between items-center tracking-wide mb-[4pt] px-[4pt] py-[4pt]"
